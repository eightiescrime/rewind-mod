...
class ClientTemporalStateTest {
    ...
    private static TemporalStatePayload calm() {
        return new TemporalStatePayload(true, 3, 100, 0.0f, 0, 0);
    }

    private static TemporalStatePayload spent() {
        return new TemporalStatePayload(true, 3, 60, 2.0f, 40, 0);
    }
    ...
    void молчит_пока_способность_не_открыта() {
        ClientTemporalState.accept(new TemporalStatePayload(false, 1, 100, 0.0f, 0, 0));
